...
public class RocketSkill : MonoBehaviour {
	...
	//===========Attacking=======================
	public GameObject rocketPefab = null;
	...
	void ShootAtEnemy()
	{
		...
		GameObject rocket = (GameObject)Instantiate (rocketPefab, transform.position,transform.rotation);
		rocket.transform.LookAt(currentTarget.transform.position);
